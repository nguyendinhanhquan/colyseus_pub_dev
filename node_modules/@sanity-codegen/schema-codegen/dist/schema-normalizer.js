...
function normalizeType(t, parents) {
  ...
  switch (type) {
    case 'Array':
      {
        ...
        const schemaArrayDef = { ...getCommonProps(t),
          type,
    ...
    case 'Block':
      {
        const of = t.of;
        const schemaBlockDef = { ...getCommonProps(t),
          type,
    ...
    case 'Object':
      {
        const schemaDef = { ...getCommonProps(t),
          type,
...
function schemaNormalizer(types) {
  const allRegisteredTypes = types.map(i => normalizeType(i, [])); // TODO: check if name is trying to override primitive types
