...
const defaultBabelOptions = {
  ...
  ['module-resolver', {
    root: ['.'],
    alias: {
      'part:@sanity/base/schema-creator': '@sanity-codegen/schema-codegen/schema-creator-shim',
      'all:part:@sanity/base/schema-type': '@sanity-codegen/schema-codegen/schema-type-shim',
      'part:@sanity/base/schema-type': '@sanity-codegen/schema-codegen/schema-type-shim',
